 ...
 */
public class Occasions extends PropertyEnlists{
    ...
    private byte[] img_1;//todo
    private byte[] img_2;//todo
    private String eventStatus;
    private String eventAdmin;
    private String eventId;
    private String contact;
    private String location;//todo
    private String hostedBy;//todo
    private String propertyName;//todo
    public String image;//todo
    String requestType;//todo
    ...
    public Occasions(String eventId,
            String eventName,
            String capacity,
            String eventType,
            String location,
