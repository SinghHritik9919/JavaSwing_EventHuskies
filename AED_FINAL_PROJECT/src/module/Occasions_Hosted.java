...
public class Occasions_Hosted {
    ...
    public Occasions_Hosted(String eventID, String event_Name, String organizer, String address, String food, int available_tickets) {
