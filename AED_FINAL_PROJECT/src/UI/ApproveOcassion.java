 ...
 * @author hriti
 */
public class ApproveOcassion extends javax.swing.JPanel {

    /**
     * Creates new form ApproveProperty
     */
    public String FName = null;
    ArrayList<Occasions> agnEvntList;
    Occasions evnts;

    public ApproveOcassion(String FirstName) {
        initComponents();
        FName = FirstName;
    ...
    public ArrayList<Occasions> evntsList() {
        agnEvntList = new ArrayList<>();
        try ( Connection conn = DbUtility.getConnection();  PreparedStatement prep1 = conn.prepareStatement(IQueryMapper.SELECT_REVEIWER_EVENTS_1);) {
...
//                        rs.getString(13), rs.getString(2), rs.getString(17));
                 evnts = new Occasions(rs.getString(2), rs.getString(6),
...
//        ArrayList<Events> list = evntsList();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/forms/eye.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/forms/update.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try 
        {
            ...
            Occasions ent = (Occasions)(jTableApprove2.getModel().getValueAt(row, 0));
...
//            jLabel10.setIcon(imageIcon1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        evnts = (Occasions) (jTableApprove2.getModel().getValueAt(row, 0));
