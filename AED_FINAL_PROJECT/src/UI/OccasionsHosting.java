...
import module.Occasions_Hosted;
 ...
 */
public class OccasionsHosting extends javax.swing.JFrame {

    /**
     * Creates new form EventHosting
     */
    public byte[] event_img2 = null;
    public OccasionsHosting() {
        initComponents();
    ...
    public ArrayList<Occasions_Hosted> eventList() {
        ArrayList<Occasions_Hosted> eventList = new ArrayList<>();
        try {
           ...
           // prep1.setString(3,jTextField2.getText());
            ...
            Occasions_Hosted events;
            while (rs.next()) {
                events = new Occasions_Hosted(rs.getString("EventId"), rs.getString("EventName"), rs.getString("Organizer"), rs.getString("Address"), rs.getString("Food"), rs.getInt("Available_Ticket"));
    ...
    public void populate_table_events() {
        ...
        model.setRowCount(0);
        ArrayList<Occasions_Hosted> list = eventList();
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/forms/eye.png"))); // NOI18N
        ...
        searchButton.setFont(new java.awt.Font("MS Reference Sans Serif", 1, 18)); // NOI18N
        searchButton.setForeground(new java.awt.Color(255, 153, 0));
        searchButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/forms/search.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        OccasionTicketBook etb = new OccasionTicketBook(EventID, EventName, Organizer, Address, food1);
        etb.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                event_img2= rs.getBytes("Imglink1");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OccasionsHosting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OccasionsHosting().setVisible(true);
            }
        });
    }
