...
public class DeleteProperty extends javax.swing.JPanel {
    ...
    public ArrayList<PropertyEnlists> propertyList (){
           ...
           try {
            ...
            while (rs.next()){
            property = new PropertyEnlists(rs.getString("PropertyId"), rs.getString("PropertyName"), rs.getString("Capacity"), rs.getString("Street"), rs.getString("City"));    
            propertyList.add(property);
            System.out.println("deleted proeprty");
            }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3), "Remove Property", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/forms/delete.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         String deleteQuery = "DELETE FROM property_enlist WHERE PropertyId ="+PropertyID;
