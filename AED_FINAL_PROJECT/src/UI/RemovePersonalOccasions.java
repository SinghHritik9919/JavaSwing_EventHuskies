 ...
 * @author Priti
 */
public class RemovePersonalOccasions extends javax.swing.JPanel {
    ...
    public RemovePersonalOccasions(String fName) {
        initComponents();
        this.fName = fName;
        populateReviewTable();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3), "DELETE EVENT", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
    ...
    private void deleteEvent(String buttonName) {
        ...
        Occasions event = (Occasions) reviewTableModel.getValueAt(selectedRow, 0);
        ...
        try ( Connection conn = DbUtility.getConnection();  
            ...
            Logger.getLogger(RemovePersonalOccasions.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void populateReviewTable() {
        ...
        List<Occasions> eventList;

        try ( Connection conn = DbUtility.getConnection();  PreparedStatement ps = conn.prepareStatement(IQueryMapper.SELECT_PERSONAL_EVENTS)) {
