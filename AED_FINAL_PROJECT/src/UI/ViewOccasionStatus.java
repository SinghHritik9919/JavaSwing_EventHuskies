 ...
 * @author vivekmishra
 */
public class ViewOccasionStatus extends javax.swing.JPanel {

    /**
     * Creates new form ViewPropertyStatus
     */
    public String FName = null;
    ArrayList<Occasions> OccasionList;
    Occasions Occasion;

    public ViewOccasionStatus(String FirstName) {
        initComponents();
    ...
    public ArrayList<Occasions> OccasionList() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Occasion.setEventId(rs.getString(1));
                Occasion.setEventName(rs.getString(5));
                Occasion.setEventDescription(rs.getString(6));
                Occasion.setStatus(rs.getString(14));
