 ...
 * @author hriti
 */
public class AssignOccassionAp extends javax.swing.JPanel {

    /**
     * Creates new form AssignPropertyAp
     */
    public String FName = null;
    ArrayList<Occasions> list;
    String comboSelected;
    ArrayList<String> rType;
    Occasions evnt;

    public AssignOccassionAp(String FirstName) {
        initComponents();
        FName = FirstName;
    ...
    public ArrayList<Occasions> eventsList() {
        ArrayList<Occasions> eventsList = new ArrayList<>();
        try {
...
//            prep1.setString(1, comboSelected);
    ...
    public void populaterequestType() {
        try ( Connection conn = DbUtility.getConnection();  PreparedStatement prep = conn.prepareStatement(IQueryMapper.FETCH_LOCATIONS);) {
...
//            row[0] = e.getEventName();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/forms/add-contact.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        evnt = (Occasions) (jTableApprove1.getModel().getValueAt(row, 0));
        System.out.println(evnt.getEventId() + ", " + evnt);

        //DefaultTableModel model = (DefaultTableModel) jTableApprove1.getModel();
        try ( Connection conn = DbUtility.getConnection();  PreparedStatement prep1 = conn.prepareStatement(IQueryMapper.UPDATE_EVENT_STATUS);) {
