 ...
 */
public class SelectPropertyForPersonalOccasions extends javax.swing.JPanel {
...
//    final DefaultComboBoxModel model = new DefaultComboBoxModel(labels);
    public SelectPropertyForPersonalOccasions() {
    ...
    public SelectPropertyForPersonalOccasions(String fName) {
        initComponents();
        propertyList();
        show_property();
        setComboLocation();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Properties: Personal Occasions");
        ...
        jTableProp.setBackground(new java.awt.Color(204, 204, 255));
...
//        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        try ( Connection conn = DbUtility.getConnection();  PreparedStatement prep = conn.prepareStatement(IQueryMapper.FETCH_TYPE);) {
