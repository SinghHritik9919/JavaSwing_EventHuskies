 ...
 */
public class OccasionTicketBook extends javax.swing.JFrame {
    ...
    public OccasionTicketBook(String EventID, String EventName, String Organizer, String Address, String food1) {
        initComponents();
        setExtendedState(JFrame.MAXIMIZED_BOTH);
        EID = EventID;
        EName = EventName;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            prep.setString(2, jLabel10.getText());
            prep.setString(3, jLabel15.getText());
            prep.setString(5, "3"); //cannot be empty //contains name
            prep.setString(1, jTextField2.getText()); //cannot be empty //mail id
            prep.setString(4, "Registered");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OccasionTicketBook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OccasionTicketBook().setVisible(true);
            }
        });
    }
