 ...
 */
public class SelectPropertyForOccasion extends javax.swing.JPanel {
...
//    final DefaultComboBoxModel model = new DefaultComboBoxModel(labels);
    public SelectPropertyForOccasion() {
    ...
    public SelectPropertyForOccasion(String fName) {
        initComponents();
        propertyList();
        show_property();
        setComboLocation();
//        setComboType();
    ...
    public PropertyEnlists getSelectedProperty() {
        return selectedProperty;
    }

    public void setSelectedProperty(PropertyEnlists selectedProperty) {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3), "Add Event ", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Lucida Grande", 0, 12))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/forms/update.png"))); // NOI18N
        jButton4.setText("Choose property");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3), "Pictures", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 12))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        selectedProperty = ((PropertyEnlists) jTableProp.getValueAt(getSelectedPropertyIndex(), 0));

        try ( Connection conn = DbUtility.getConnection();  PreparedStatement ps = conn.prepareStatement(IQueryMapper.INSERT_SELECTED_PLACES_FOR_EVENT);) {
    ...
    private void jTablePropMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablePropMouseClicked
        ...
        PropertyEnlists e = (PropertyEnlists) jTableProp.getValueAt(selectedRow, 0);
...
//        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        try ( Connection conn = DbUtility.getConnection();  PreparedStatement prep = conn.prepareStatement(IQueryMapper.FETCH_CAPACITY);) {
